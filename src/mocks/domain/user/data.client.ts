...
export const clientAdminData = {
  ...
  username: clientAdminEmployee.e_user_name,
  ...
  userScope: "CLIENT",
  companyId: clientAdminEmployee.e_cid.toString(),
  permission: 9,
  role: "ADMIN",
...
export const clientManagerData = {
  ...
  username: clientManagerEmployee.e_user_name,
  ...
  userScope: "CLIENT",
  companyId: clientManagerEmployee.e_cid.toString(),
  permission: 7,
  role: "MANAGER",
  canUseSuperUser: null,
  canUseImpersonation: null,
...
export const clientLeaderData = {
  ...
  username: clientLeaderEmployee.e_user_name,
  ...
  userScope: "CLIENT",
  companyId: clientLeaderEmployee.e_cid.toString(),
  permission: 7,
  role: "LEADER",
  canUseSuperUser: null,
  canUseImpersonation: null,
...
export const clientUserData = {
  ...
  username: clientUserEmployee.e_user_name,
  ...
  userScope: "CLIENT",
  companyId: clientUserEmployee.e_cid.toString(),
  permission: 3,
  role: "USER",
  canUseSuperUser: null,
  canUseImpersonation: null,
...
export const clientGuestData = {
  ...
  username: clientGuestEmployee.e_user_name,
  ...
  userScope: "CLIENT",
  companyId: clientGuestEmployee.e_cid.toString(),
  permission: 1,
  role: "GUEST",
  canUseSuperUser: null,
  canUseImpersonation: null,
