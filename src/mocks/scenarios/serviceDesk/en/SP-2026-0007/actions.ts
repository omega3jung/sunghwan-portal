...
export const actions: TicketActionMockInput[] = [
  ...
  },
  {
    ...
    tka_action_type: "COMMENT",
    tka_content:
      "We confirmed the HR termination record. Aria Young's last working day was July 23, 2026, and the account is eligible for termination. The offboarding checklist has also been updated to show that the IT account lock is complete.",
