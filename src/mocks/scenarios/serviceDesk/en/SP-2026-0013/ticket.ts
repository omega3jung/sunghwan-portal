...
export const ticket: TicketMockInput = {
  ...
  tk_content:
    "Hello. Generation data for Solar Farm A is not updating on Client Demo Energy's Energy Operations Dashboard.<br><br>The last update time is displayed as July 29, 2026, at 14:35, and selecting the Refresh button produces an “Unable to synchronize telemetry data” error. The latest data is available normally in the external monitoring system.<br><br>This is affecting the operational status and daily generation reports, so please investigate as soon as possible.",
  tk_email: {
    to: [
