...
export const ticket: TicketMockInput = {
  ...
  tk_content:
    "Hello. Generation data for Solar Farm A on the Energy Operations Dashboard has not been updated since July 29, 2026, at 14:35.<br><br>The latest generation data is available in the external monitoring system, so please first check the internal telemetry collection and report data processing pipeline for issues. This is affecting the operational status and daily generation reports.",
  tk_email: {
    to: [
