...
export const ticket: TicketMockInput = {
  ...
  tk_content:
    "안녕하세요. Non-phone Repair 팀의 Manager인 Aria Young이 2026-07-23부로 퇴사했습니다.<br><br>aria.young@sunghwan-portal.dev 계정을 즉시 잠그고 활성 세션, MFA 등록 정보와 API 토큰을 회수해 주세요. 보안 처리가 완료되면 HR 부서에 퇴사 및 계정 종료 대상이 맞는지 최종 확인을 요청해 주세요.",
  tk_email: {
    to: [
