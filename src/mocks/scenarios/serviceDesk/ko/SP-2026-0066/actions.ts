...
export const actions: TicketActionMockInput[] = [
  {
    ...
    tka_created_at: "2026-09-06T06:22:11Z",
    tka_updated_at: null,
    tka_active: true,
  ...
  },
  {
    ...
    tka_created_at: "2026-09-06T06:25:44Z",
    tka_updated_at: null,
    tka_active: true,
  ...
  },
  {
    ...
    tka_content:
      "이 티켓은 동일한 DB 잠금으로 인해 발생한 같은 incident이므로 SP-2026-0065에 병합되었습니다.<br>이후 추적과 커뮤니케이션은 대표 티켓에서 계속 진행됩니다.",
    tka_owner_username: "daniel_kim",

    tka_created_at: "2026-09-06T07:13:18Z",
    tka_updated_at: null,
    tka_active: true,
