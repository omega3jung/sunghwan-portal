...
export const ticket: TicketMockInput = {
  ...
  tk_content:
    "안녕하세요. Client Demo Energy 포털의 Energy Operations Dashboard에서 Solar Farm A의 발전량 데이터가 갱신되지 않고 있습니다.<br><br>마지막 갱신 시간은 2026-08-29 14:35로 표시되며, Refresh 버튼을 누르면 “Unable to synchronize telemetry data” 오류가 발생합니다. 외부 모니터링 시스템에서는 최신 데이터가 정상적으로 확인됩니다.<br><br>운영 현황과 일일 발전량 보고서에 영향을 주고 있으므로 빠른 확인을 요청합니다.",
  tk_email: {
    to: [
