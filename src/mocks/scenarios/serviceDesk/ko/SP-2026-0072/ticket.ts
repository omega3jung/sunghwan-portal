...
export const ticket: TicketMockInput = {
  ...
  tk_content:
    "안녕하세요. Energy Operations Dashboard에서 Solar Farm A의 발전량 데이터가 2026-08-29 14:35 이후 갱신되지 않고 있습니다.<br><br>외부 모니터링 시스템에서는 최신 발전량이 정상적으로 확인되므로, 내부 telemetry 수집 및 보고 데이터 처리 과정에 이상이 있는지 우선 점검해주세요. 운영 현황과 일일 발전량 보고서에 영향을 주고 있습니다.",
  tk_email: {
    to: [
