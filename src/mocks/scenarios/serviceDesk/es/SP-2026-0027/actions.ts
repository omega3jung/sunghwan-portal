...
export const actions: TicketActionMockInput[] = [
  ...
  },
  {
    ...
    tka_action_type: "COMMENT",
    tka_content:
      "Hemos confirmado el registro de baja en Recursos Humanos. El último día de trabajo de Aria Young fue el 23 de julio de 2026 y la cuenta debe cerrarse. También actualizamos la lista de verificación de salida para indicar que el bloqueo de la cuenta de IT se completó.",
