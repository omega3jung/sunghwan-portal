...
export const ticket: TicketMockInput = {
  tk_id: "b67e6f5a-e632-4e9b-b70b-005992c2a7a6",
  ...
  tk_merged_into_ticket_id: "c1915a85-6ad9-4aa3-87b6-80981951b542",
  ...
  tk_content:
    "Hola. Los datos de generación de Solar Farm A en Energy Operations Dashboard no se actualizan desde el 29 de julio de 2026 a las 14:35.<br><br>Los datos de generación más recientes aparecen correctamente en el sistema de monitoreo externo. Revise primero si existe algún problema en la recopilación interna de telemetry o en el procesamiento de datos de los informes. Esto afecta al estado operativo y a los informes diarios de generación.",
  tk_email: {
    to: [
