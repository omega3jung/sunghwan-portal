...
export const histories: TicketHistoryMockInput[] = [
  {
    ...
    tkh_created_at: "2026-09-06T06:13:27Z",
  },
  {
    tkh_ticket_id: ticket.tk_id,
    tkh_history_no: 2,
    ...
    tkh_created_at: "2026-09-06T06:18:09Z",
  },
  {
    tkh_ticket_id: ticket.tk_id,
    tkh_history_no: 3,
    ...
    tkh_created_at: "2026-09-06T06:20:03Z",
  },
  {
    tkh_ticket_id: ticket.tk_id,
    tkh_history_no: 4,
    ...
    tkh_created_at: "2026-09-06T06:22:11Z",
  },
  {
    tkh_ticket_id: ticket.tk_id,
    tkh_history_no: 5,
    ...
    tkh_created_at: "2026-09-06T06:25:44Z",
  },
  {
    tkh_ticket_id: ticket.tk_id,
    tkh_history_no: 6,
    ...
    tkh_metadata: {
      ...
      targetScope: "PORTAL",
      reason:
        "Doublon du même incident de performance du portail déjà suivi dans SP-2026-0045",
      note: "Closed as merged child ticket",
    },

    tkh_created_at: "2026-09-06T07:12:34Z",
  },
];
