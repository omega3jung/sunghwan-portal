...
export const actions: TicketActionMockInput[] = [
  {
    ...
    tka_created_at: "2026-09-07T01:20:14Z",
    tka_updated_at: null,
    tka_active: true,
    tka_metadata: {},
    tka_files: [],
  ...
  },
  {
    ...
    tka_owner_username: "julian_moon",
    tka_created_at: "2026-09-07T02:02:38Z",
    tka_updated_at: null,
    tka_active: true,
    tka_metadata: {
  ...
  },
  {
    ...
    tka_owner_username: "julian_moon",
    tka_created_at: "2026-09-07T02:04:12Z",
    tka_updated_at: null,
    tka_active: true,
    tka_metadata: {
  ...
  },
  {
    ...
    tka_action_type: "COMMENT",
    tka_content:
      "Nous avons confirmé le dossier de départ auprès des Ressources humaines. Le dernier jour de travail d’Aria Young était le 23 juillet 2026 et le compte doit bien être clôturé. La liste de contrôle de départ indique désormais que le verrouillage du compte IT est terminé.",
    tka_owner_username: "matthew_williams",
    tka_created_at: "2026-09-07T02:34:45Z",
    tka_updated_at: null,
    tka_active: true,
    tka_metadata: {
  ...
  },
  {
    ...
    tka_owner_username: "julian_moon",
    tka_created_at: "2026-09-07T02:40:06Z",
    tka_updated_at: null,
    tka_active: true,
    tka_metadata: {
