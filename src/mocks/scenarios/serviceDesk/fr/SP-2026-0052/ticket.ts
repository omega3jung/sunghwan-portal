...
export const ticket: TicketMockInput = {
  ...
  tk_created_at: "2026-09-12T05:46:12Z",
  tk_updated_at: "2026-09-13T08:20:34Z",
  ...
  tk_content:
    "Bonjour. Les données de production de Solar Farm A dans Energy Operations Dashboard ne sont plus mises à jour depuis le 29 juillet 2026 à 14:35.<br><br>Les données de production les plus récentes sont disponibles normalement dans le système de surveillance externe. Veuillez donc vérifier en priorité la collecte interne des données de télémétrie et le traitement des données de rapport. Ce problème affecte l’état opérationnel et les rapports quotidiens de production.",
  tk_email: {
    to: [
