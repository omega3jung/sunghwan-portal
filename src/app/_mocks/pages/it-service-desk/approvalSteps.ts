...
export const tenantApprovalStepSettingsMock: DbCategoryApprovalSettings[] = [
  /* Portal / System */
  {
    ...
    approval_step: [
      ...
      {
        approval_step_id: "12",
        approval_step_name: { en: "IT manager's approval" },
        approval_step_description: { en: "Check to if internal issue" },
  ...
  /* HR Systems */
  {
    ...
    approval_step: [
      {
        approval_step_id: "18",
        approval_step_name: { en: "HR manager's approval" },
        approval_step_description: { en: "Check to if HR issue" },
        approval_step_index: 1,
        category_id: hrSystemPayrollCategoryMock.category_id,
        approval_step_assignee: {
          type: "JOB_FIELD",
