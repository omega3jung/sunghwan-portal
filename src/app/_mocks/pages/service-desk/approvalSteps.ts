...
export const internalApprovalStepSettingsMock: DbCategoryApprovalSettings[] = [
  /* Portal / System */
  {
    ...
    category_request_template:
      internalPortalSystemIssueCategoryMock.category_request_template,
    ...
    default_priority: internalPortalSystemIssueCategoryMock.default_priority,
    default_risk_level:
      internalPortalSystemIssueCategoryMock.default_risk_level,
    default_sla_days: internalPortalSystemIssueCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 1,
        approval_step_name: {
  ...
  /* Account & Access */
  {
    ...
    category_request_template:
      accountAccessCategoryMock.category_request_template,
    category_index: accountAccessCategoryMock.category_index,
    category_active: accountAccessCategoryMock.category_active,
    default_priority: accountAccessCategoryMock.default_priority,
    default_risk_level: accountAccessCategoryMock.default_risk_level,
    default_sla_days: accountAccessCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 2,
        approval_step_name: {
  ...
  /* Hardware & Device */
  {
    ...
    category_request_template:
      hardwareDeviceCategoryMock.category_request_template,
    category_index: hardwareDeviceCategoryMock.category_index,
    category_active: hardwareDeviceCategoryMock.category_active,
    default_priority: hardwareDeviceCategoryMock.default_priority,
    default_risk_level: hardwareDeviceCategoryMock.default_risk_level,
    default_sla_days: hardwareDeviceCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 3,
        approval_step_name: {
  ...
  /* Software & App */
  {
    ...
    category_request_template:
      softwareApplicationCategoryMock.category_request_template,
    ...
    default_priority: softwareApplicationCategoryMock.default_priority,
    default_risk_level: softwareApplicationCategoryMock.default_risk_level,
    default_sla_days: softwareApplicationCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 4,
        approval_step_name: {
  ...
  /* Network */
  {
    ...
    category_request_template:
      networkConnectivityCategoryMock.category_request_template,
    ...
    default_priority: networkConnectivityCategoryMock.default_priority,
    default_risk_level: networkConnectivityCategoryMock.default_risk_level,
    default_sla_days: networkConnectivityCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 5,
        approval_step_name: {
  ...
  /* Printing */
  {
    ...
    category_request_template:
      printingOfficeEquipmentCategoryMock.category_request_template,
    ...
    default_priority: printingOfficeEquipmentCategoryMock.default_priority,
    default_risk_level: printingOfficeEquipmentCategoryMock.default_risk_level,
    default_sla_days: printingOfficeEquipmentCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 6,
        approval_step_name: {
  ...
  /* HR Systems */
  {
    ...
    category_request_template:
      hrSystemPayrollCategoryMock.category_request_template,
    category_index: hrSystemPayrollCategoryMock.category_index,
    category_active: hrSystemPayrollCategoryMock.category_active,
    default_priority: hrSystemPayrollCategoryMock.default_priority,
    default_risk_level: hrSystemPayrollCategoryMock.default_risk_level,
    default_sla_days: hrSystemPayrollCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 7,
  ...
  /* Data Management */
  {
    ...
    category_request_template:
      dataInfoManagementCategoryMock.category_request_template,
    ...
    default_priority: dataInfoManagementCategoryMock.default_priority,
    default_risk_level: dataInfoManagementCategoryMock.default_risk_level,
    default_sla_days: dataInfoManagementCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 8,
        approval_step_name: {
  ...
  /* Client Support */
  {
    ...
    category_request_template:
      clientUserSupportCategoryMock.category_request_template,
    category_index: clientUserSupportCategoryMock.category_index,
    category_active: clientUserSupportCategoryMock.category_active,
    default_priority: clientUserSupportCategoryMock.default_priority,
    default_risk_level: clientUserSupportCategoryMock.default_risk_level,
    default_sla_days: clientUserSupportCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 9,
        approval_step_name: {
  ...
  /* Other Inquiry */
  {
    ...
    category_request_template:
      otherInquiryCategoryMock.category_request_template,
    category_index: otherInquiryCategoryMock.category_index,
    category_active: otherInquiryCategoryMock.category_active,
    default_priority: otherInquiryCategoryMock.default_priority,
    default_risk_level: otherInquiryCategoryMock.default_risk_level,
    default_sla_days: otherInquiryCategoryMock.default_sla_days,
    approval_step: [],
  },
];
...
export const tenantApprovalStepSettingsMock: DbCategoryApprovalSettings[] = [
  /* Portal / System */
  {
    ...
    category_request_template:
      tenantPortalSystemIssueCategoryMock.category_request_template,
    ...
    default_priority: tenantPortalSystemIssueCategoryMock.default_priority,
    default_risk_level: tenantPortalSystemIssueCategoryMock.default_risk_level,
    default_sla_days: tenantPortalSystemIssueCategoryMock.default_sla_days,
    approval_step: [
      {
        approval_step_id: 11,
        approval_step_name: {
