...
export const comments: DbTicketComment[] = [
  {
    ...
    body: "Hi, isabella. Could you give an details what info should be include?",
    owner_id: "41",
  ...
  },
  {
    ...
    body: "It should have receive ID, receive date, IMEI, SKU, employee ID, status and current location.",
    owner_id: "53",
  ...
  },
  {
    ...
    body: "Here's the report. If you need any help, please let us know. Thank you.",
    owner_id: "41",
