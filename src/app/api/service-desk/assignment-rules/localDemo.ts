import type { DbAssignmentRule } from "@/api/serviceDesk/assignmentRule/mapper";
...
const getClientRulesOrThrow = (items: AssignmentRuleStore, clientId: string) => {
...
const getRuleIndexByCategoryId = (rules: DbAssignmentRule[], categoryId: string) => {
...
export const localUpdateAssignmentRule = ({
  ...
  const targetRuleIndex = getRuleIndexByCategoryId(targetRules, input.categoryId);
