...
/** Handles GET /api/employees/[id]; authorization and runtime adapter selection remain at this HTTP boundary. */
...
/** Handles PUT /api/employees/[id]; authorization and runtime adapter selection remain at this HTTP boundary. */
...
/** Handles DELETE /api/employees/[id]; authorization and runtime adapter selection remain at this HTTP boundary. */
