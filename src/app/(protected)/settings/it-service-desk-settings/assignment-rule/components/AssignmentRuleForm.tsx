            ...
            <FieldGroup>
              <Field>
                ...
                <Input
                  ...
                  placeholder={t(
                    "itServiceDeskSettings.assignmentRuleTab.namePlaceholder",
                  )}
                  readOnly
                />
              </Field>
              <Field>
                <FieldLabel htmlFor="assignment-rule-select-job-field">
                  {t("itServiceDeskSettings.assignmentRuleTab.jobField")}
                </FieldLabel>
                <MultiComboBox
                  ...
                  disabled={!selectedNode}
                  placeholder={t(
                    "itServiceDeskSettings.assignmentRuleTab.selectAssigneJobField",
                  )}
              ...
              <Field>
                <FieldLabel htmlFor="assignment-rule-select-employee">
                  {t("itServiceDeskSettings.assignmentRuleTab.employee")}
                </FieldLabel>
                <AvatarMultiComboBox
