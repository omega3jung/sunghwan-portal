...
declare global {
  ...
  var __SUNGHWAN_PORTAL_LOCAL_DEMO_TICKET_STATE__:
    | LocalDemoTicketState
    | undefined;
}
...
function getLocalDemoTicketState() {
  if (!globalThis.__SUNGHWAN_PORTAL_LOCAL_DEMO_TICKET_STATE__) {
    globalThis.__SUNGHWAN_PORTAL_LOCAL_DEMO_TICKET_STATE__ =
      createLocalDemoTicketState();
  }

  return globalThis
    .__SUNGHWAN_PORTAL_LOCAL_DEMO_TICKET_STATE__ as LocalDemoTicketState;
}
